<?
    ...
    $version = $_GET['version'] == '' ? 'c' : $_GET['version'];
            ...
            if(mysqli_query($conn, $query)){
                if(!$first_step){
                    ...
                    $mail->Body    = '<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#3d3834;">
										<tr>
											<td colspan="5" style="text-align:center; font-size:12px">Si no puedes ver este mensaje de forma correcta da clic <a href="#">aquí</a></td>
										</tr>
                                      <tr height="350">
                                      ...
                                      <tr>
										...
										<td colspan="3">
											...
											<p>Gracias por tu interés en las soluciones que Maxcom ofrece a empresas como la
tuya. Estamos seguros de que encontrarás nuestra oferta muy atractiva.</p>
											<p>En breve un ejecutivo se pondrá en contacto contigo para conocer mejor
...
Si tienes alguna pregunta o comentario no dudes en <a href="#" style="color:#c12030">contactarnos</a>.</p>
										...
										<tr>
										<td width="33"></td>
										<td width="178"><a href="#"><img src="http://23.253.99.79/maxcom/emm/mailing/resources/mailing_maxcom_18052015_02.jpg" width="178" height="170" alt="Hug Conectuvity" ></a></td>
