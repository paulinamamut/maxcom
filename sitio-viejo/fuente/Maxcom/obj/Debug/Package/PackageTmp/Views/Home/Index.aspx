...
<meta name="description" content="Maxcom te ofrece las soluciones en comunicación que se adaptan a tus necesidades.">
...
<body>
        ...
        <div id="slider">
            ...
            <div id="tray">
                <!--[if lt IE 9]><div class="slide"><![endif]--><!--[if gte IE 9]><!--><section class="slide"><!--<![endif]-->
                    <div class="card">
                        <div class="bg">
                            <img src="/img/hogar.png" alt="Max Conexión" class="lob"><!--
                            --><p>Nos adaptamos a tus necesidades de comunicación y conectividad con una gran variedad de paquetes y planes de Internet, televisión y telefonía fija o móvil, ofreciéndote un servicio de excelencia.</p>
                            <a class="btn-sombra" href="/en-tu-hogar/">Conoce más</a>
                        </div>
                        <img src="/img/contenido/home-hogar.png" class="hero" alt="En tu hogar">
                    </div>
                ...
                <!--[if lt IE 9]><div class="slide"><![endif]--><!--[if gte IE 9]><!--><section class="slide"><!--<![endif]-->
                    <div class="card">
                        <div class="bg">
                            ...
                            --><p>Tu empresa necesita soluciones de comunicación que optimicen sus procesos y mejoren la productividad al menor costo posible y con un servicio impecable. Ahí es donde entra maxcom.</p>
                            <a class="btn-sombra" href="/en-tu-empresa/">Conoce más</a>
                        </div>
                ...
                <!--[if lt IE 9]><div class="slide"><![endif]--><!--[if gte IE 9]><!--><section class="slide"><!--<![endif]-->
                    <div class="card">
                        <div class="bg">
                            ...
                            <div class="two_col">
                                <h3>Contrata Internet y te incluímos la telefonía fija.</h3>
                                <ul>
                                    <li>3, 6 u 8 Mb de Internet de Banda Ancha**.</li>
                                    <li>Llamadas locales, larga distancia nacional e internacional (EUA y Canadá) ilimitados.</li>
                            ...
                            --><div class="two_col">
                                ...
                                <a class="btn-sombra" href="#">Conoce más</a>
                            </div>
                        </div>
                    </div>
                <!--[if gte IE 9]><!--></section><!--<![endif]--><!--[if lt IE 9]></div><![endif]-->
    ...
    <!--[if lt IE 9]><div id="footer"><![endif]--><!--[if gte IE 9]><!--><footer><!--<![endif]-->
        ...
        <a id="porta" class="btn-sombra" href="/secciones/atencion-a-clientes/portabilidad/">Portabilidad</a>
