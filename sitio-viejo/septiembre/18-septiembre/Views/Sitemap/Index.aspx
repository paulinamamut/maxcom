...
<meta property="og:url" content="http://www.maxcom.com/Sitemap/" /> 
...
<body id="inner">
    ...
    <div id="wrapper" class="tc">
        ...
        <div class="pad">
            ...
            <div class="half">
                <ul class="half">
                    <li><a href="/en-tu-hogar/">maxcom Hogar</a>
                        <ul>
                ...
                --><ul class="half">
                    <li><a href="/en-tu-empresa/">maxcom en tu Empresa</a>
                        <ul>
            ...
            --><div class="half">
                <ul class="half">
                    <li><a href="/atencion-a-clientes/">Atenci&oacute;n a clientes</a>
                        <ul>
                            <li><a href="/atencion-a-clientes/envianos-un-mensaje/">Env&iacute;anos un mensaje</a>
                                <ul>
                                    <li><a href="/atencion-a-clientes/envianos-un-mensaje/quiero-ser-cliente/">Quiero ser cliente</a></li>
                                    <li><a href="/atencion-a-clientes/envianos-un-mensaje/ya-soy-cliente/">Ya soy cliente</a></li>
                                </ul>
                            </li>
                ...
                --><ul class="half">
                    <li><a href="/sobre-maxcom/">Sobre Maxcom</a>
                        <ul>
                            <li><a href="/atencion-a-clientes/localizador/">Cobertura y Sucursales</a></li>
                            <li><a href="/sobre-maxcom/oficinas-corporativas/">Oficinas Corporativas</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!--
            --><div class="half">
                ...
                --><ul class="half">
                    <li><a href="/acceso-clientes/">Acceso a clientes</a>
                        <ul>
                            <li><a href="/acceso-clientes/mail/">Consulta tu mail</a></li>
                            <li><a href="/acceso-clientes/audio-conferencia/">Accede a Audio Conferencia</a></li>
                            <li><a href="/acceso-clientes/detalle-llamadas/">Detalle de llamadas</a></li>
                            <li><a href="/acceso-clientes/mi-cuenta/">Mi cuenta maxcom</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!--
            --><div class="half">
                ...
                --><ul class="half">
                    <li><a href="https://twitter.com/Maxcom_Mexico" target="_blank">Twitter</a></li>
                    <li><a href="https://www.facebook.com/MaxcomMexico" target="_blank">Facebook</a></li>
                    <li><a href="https://www.youtube.com/user/MaxcomContigo" target="_blank">YouTube</a></li>
                </ul>
            </div>
        </div>
