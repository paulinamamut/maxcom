...
<head>
<meta charset="UTF-8">
<title>Maxcom | Soluciones de Comunicaci&oacute;n</title>
...
<meta property="og:url" content="http://www.maxcom.com/en-tu-empresa/soluciones-de-comunicacion" /> 
...
<body id="inner">
    ...
    <div id="wrapper">
                ...
                <ul id="nav">
                    ...
                    <li><a href="/en-tu-empresa/" class="current">maxcom for Business</a>
                        <ul id="submenu">
                            ...
                            <li><span class="current">Enjoy Collaboration</span></li>
        ...
        <!--[if lt IE 9]><div class="section comunicacion"><![endif]--><!--[if gte IE 9]><!--><section class="comunicacion"><!--<![endif]-->
        <div class="pad">
            <h1 class="icon business foryou">Enjoy Collaboration</h1>
            <p>Son tecnolog&iacute;as que permiten establecer sistemas de colaboraci&oacute;n en sitio y de forma remota. Son servicios que incrementan la productividad al facilitar una mejor comunicaci&oacute;n entre empleados, clientes y proveedores, utilizando medios m&oacute;viles, herramientas de colaboraci&oacute;n y mensajer&iacute;a.</p>
            <p>Son servicios para empresas que tienen diversas localidades y empleados m&oacute;viles que requieren en todo momento mantenerse comunicados.</p>
        </div>
...
<!-- **************************************************************************************************************************************** -->
        ...
        <div class="pad">
            <div class="half">
            <img alt="Empresas peque&ntilde;as" src="/img/contenido/enjoy-collaboration.jpg" class="imagen-half">
            <a href="http://www.youtube.com/embed/5gGzorTIzi8" class="btn-sombra show">Ver Video</a>
            </div>
            <div class="box half-cont comunicacion">
                    <h5>Beneficios</h5>
                    <ul>
                        <li>Incremento en la comunicaci&oacute;n con empleados y proveedores</li>
                        <li>Movilidad para mantener la comunicaci&oacute;n desde cualquier lugar</li>
                        <li>Mensajer&iacute;a masiva para comunicarse m&aacute;s r&aacute;pido con los clientes</li>
                        <li>Ahorro de Costos en Roaming Nacional para uso celular</li>
                        <li>Reducir costos al intercomunicar sucursales remotas</li>
                        <li>Comunicaci&oacute;n de campa&ntilde;as de marketing y cobranza a bajos costos</li>
                        <li>Ahorro en vi&aacute;ticos al usar herramientas de colaboraci&oacute;n</li>
                    </ul>
                </div>
            </div>
        <!--[if gte IE 9]><!--></section><!--<![endif]--><!--[if lt IE 9]></div><![endif]-->
