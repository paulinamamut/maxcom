...
<body id="inner">
    ...
    <div id="wrapper" class="tc">
        ...
        <div class="pad">
            ...
            <p>Aviso dirigido a los titulares de datos personales que obran en posesión de Maxcom Telecomunicaciones, S.A.B. de C.V.</p>

            <p>Maxcom Telecomunicaciones, S.A.B. de C.V., (Maxcom) con domicilio en Guillermo González Camarena No. 2000, Col. Centro de Ciudad Santa Fe, C.P. 01210 en México, D.F., hace de su conocimiento que los datos personales de usted, incluyendo los sensibles, que actualmente o en el futuro obren en nuestras bases de datos, serán tratados y/o utilizados por Maxcom y/o las empresas controladoras de la misma y/o nuestras empresas filiales y/o subsidiarias y/o aquellos terceros que, por la naturaleza de sus trabajos o funciones tengan la necesidad de tratar y/o utilizar sus datos personales; con el propósito de cumplir aquellas obligaciones que se derivan de la relación jurídica existente entre usted como titular de los datos personales y empresas antes señaladas.</p>

            <p>Maxcom podrá transferir los datos personales que obren en sus bases de datos a cualesquiera de las empresas y/o las empresas controladoras de la misma y/o nuestras empresas filiales y/o subsidiarias e incluso a terceras personas, nacionales o extranjeras, salvo que los titulares respectivos manifiesten expresamente su oposición, en términos de los dispuesto por la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (la Ley).</p>

            <p>Los titulares podrán ejercer los derechos que les confiere la Ley, a partir del 1º de enero de 2013, mediante una solicitud por escrito que deberá ser presentada en cualquiera de los domicilios de los Centros de Atención a Clientes de Maxcom y Casa Maxcom que pueden ser ubicadas en el número telefónico 5147-5147. </p>

            <p>Todas las solicitudes que sean presentadas a Maxcom, independientemente del medio utilizado por los titulares, deberán: </p>
            ...
            <ul>	
                ...
                <li>Incluir una descripción clara y precisa de los datos personales respecto de los cuales ejercitará los derechos conforme a la Ley. </li>	
                <li>Incluir cualquier elemento o documento que facilite la localización de los datos personales de que se traten. </li>
            </ul>

            <p>Maxcom se reserva el derecho de cambiar, modificar, complementar y/o alterar el presente aviso, en cualquier momento, en cuyo caso se hará de su conocimiento a través de cualquiera de los medios que establece la legislación en la materia.</p>
        </div>
