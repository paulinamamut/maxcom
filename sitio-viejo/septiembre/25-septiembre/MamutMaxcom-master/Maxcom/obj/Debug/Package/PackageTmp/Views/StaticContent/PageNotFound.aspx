...
<body id="inner">
    <!-- Google Tag Manager -->
    <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-M8JGWW"
    ...
    <div id="wrapper" class="tc">
        <!--[if lt IE 9]><div id="header"><![endif]--><!--[if gte IE 9]><!--><header><!--<![endif]-->
            ...
            <ul id="nav">
                    ...
                    <li><a href="../secciones/en-tu-empresa">maxcom for Business</a></li>
                    <li><a href="../secciones/atencion-a-clientes/">Atención a clientes</a></li>
                    <li><a href="../secciones/sobre-maxcom/">Sobre maxcom</a></li>
        ...
        <!--[if lt IE 9]><div class="section"><![endif]--><!--[if gte IE 9]><!--><section><!--<![endif]-->
            <div class="pad">
                ...
                <p>La dirección a la que trataste de entrar no existe, puede ser que sea una liga vieja o que la dirección esté mal escrita. Prueba lo siguiente:</p>
                <ul>
                    <li>Verifica que la dirección esté escrita correctamente.</li>
                    <li>Consulta nuestro <a href="../secciones/sitemap/">mapa de sitio</a>.</li>
                    <li>Regresa al <a href="../">inicio</a>.</li>
                </ul>
        ...
        <!--[if lt IE 9]><ul id="legal" class="nav"><![endif]--><!--[if gte IE 9]><!--></nav><nav id="legal" role="navigation"><ul><!--<![endif]-->
                <li><a href="../secciones/aviso-de-privacidad">Aviso de privacidad</a></li>
                <li><a href="../secciones/terminos-y-condiciones">Términos y condiciones</a></li>
                <li><a href="../secciones/sitemap/">Mapa de sitio</a></li>
                <li><a href="https://career8.successfactors.com/career?company=C0004311618P" target="_blank">Trabaja con nosotros</a></li>
                <li><a href="../secciones/atencion-a-clientes/portabilidad/">Portabilidad</a></li>
            </ul>
