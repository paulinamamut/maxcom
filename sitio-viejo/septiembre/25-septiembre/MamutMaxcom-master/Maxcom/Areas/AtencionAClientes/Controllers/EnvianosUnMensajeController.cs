...
<head>
    ...
    <p><b>C&oacute;digo Postal:</b>&nbsp;{7}</p>
    <p><b>Entidad:</b>&nbsp;{6}</p>";
        ...
        public ActionResult QuieroSerCliente(string nombre, string email, string telefono, string calle,
            ...
            string entidad, string asunto, string mensaje, string operation, string cpostal, string lada, string horario) {
	...
	<p>Al mes por todos tus servicios</p>
        ...
        public ActionResult YaSoyCliente(string nombre, string contrato, string email, string telefono,
            string asunto, string mensaje, string operation, string lada, string horario) {
            var regex =
                new Regex(
                    @"^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$");
            if (string.IsNullOrEmpty(operation)) return View();
        ...
        private static string SendEmailQuieroSer(string message, string subject, string client) {
            ...
            return SendEmail(message, subject, mailTo, client);
        }

        private static string SendEmailYaSoy(string message, string subject, string client) {
            var mailList = new List<string>();
        ...
        private static string SendEmail(string message, string subject, string[] mailTo, string client) {
            try {
                ...
                mailSmtp.SendMail(from, mailTo, new[] { client, "servicio.cliente@maxcom.com" }, subject, message);
                return "OK";
            } catch (Exception ex) {
