...
<head>
<meta charset="UTF-8">
<title>Maxcom | Tutoriales y Gu&iacute;as</title>
...
<meta property="og:url" content="http://www.maxcom.com/atencion-a-clientes/tutoriales-y-guias/" /> 
...
<!-- ********************* Termina Lightbox ********************* -->  
    <div id="wrapper">
            ...
            <ul id="nav">
                    ...
                    <li><a href="/atencion-a-clientes/" class="current">Atenci&oacute;n a clientes</a>
                        <ul id="submenu">
                            ...
                            <li><span class="current">Tutoriales y gu&iacute;as</span></li>
       ...
       <!--[if lt IE 9]><div class="section"><![endif]--><!--[if gte IE 9]><!--><section><!--<![endif]-->
        <div class="pad">
            <h1 class="icon tutoriales">Tutoriales y Gu&iacute;as</h1>
            <p>&iquest;Necesitas ayuda para contratar VOD&#63; &iquest;No conoces nuestras soluciones digitales&#63; &iquest;Sabes usar la gu&iacute;a interactiva&#63; Visita nuestras gu&iacute;as y tutoriales para conocer m&aacute;s. </p>
        </div>
        <!--[if gte IE 9]><!--></section><!--<![endif]--><!--[if lt IE 9]></div><![endif]-->
        <!--[if lt IE 9]><div class="section section"><![endif]--><!--[if gte IE 9]><!--><section class="last"><!--<![endif]-->
        <div class="pad">
            <h2>Tutoriales y Gu&iacute;as</h2>
            
            <div class="product red one-third">
                <img alt="C&oacute;mo usar las soluciones digitales" src="/img/contenido/sobre.png">
                <h3>Gu&iacute;a</h3>
                <p>C&oacute;mo usar las soluciones digitales</p>
                <a href="/pdf/guia_servicios_digitales.pdf" class="btn" target="pdf">Descargar Gu&iacute;a</a>
            </div><!--
            --><div class="product red one-third">
                <img alt="Cambio de contrase&ntilde;a TPLINK" src="/img/contenido/acceso-clientes.png">
                <h3>Video Tutorial</h3>
                <p>Cambio de contrase&ntilde;a TPLINK</p>
                <a href="http://www.youtube.com/embed/o1wWdWjnAPY" class="btn show">Ver Video</a>
            </div><!--
            --><div class="product red one-third">
                <img alt="C&oacute;mo contratar VOD" src="/img/contenido/acceso-clientes.png">
                <h3>Video Tutorial</h3>
                <p>C&oacute;mo utilizar la gu&iacute;a interactiva de TV</p>
                <a href="http://www.youtube.com/embed/RExeIQuFvfA" class="btn show">Ver Video</a>
            </div><!--
            --><div class="product red one-third">
                <img alt="C&oacute;mo contratar VOD" src="/img/contenido/acceso-clientes.png">
                <h3>Video Tutorial</h3>
                <p>Configuraci&oacute;n M&oacute;dem  Linitec LT150 maxcom</p>
                <a href="http://www.youtube.com/embed/LVz-2GTTUDU" class="btn show">Ver Video</a>
            </div>
