        ...
        <div class="pad">
            ...
            <p>En maxcom te ofrecemos un servicio de preferencia, si tienes dudas o cualquier inquietud puedes contactarnos utilizando el siguiente formato. Si a&uacute;n no eres cliente y quieres mayor informaci&oacute;n sobre cobertura en tu zona <a href="/atencion-a-clientes/localizador/">haz clic aqu&iacute;</a>. Uno de nuestros ejecutivos se pondr&aacute; en contacto contigo para responderte a la brevedad.</p>
                <form action="#" method="post">
                    ...
                    <label class="obligatorio">Correo electr&oacute;nico:<input type="text" name="email" value="<%=ViewData["QuieroEmail"]%>"/></label>
                    <label class="obligatorio short">N&uacute;mero telef&oacute;nico de contacto:
                    <div><input type="text" name="lada" style="width:15%;display:inline" value="<%=ViewData["QuieroLada"]%>"/>&nbsp;-&nbsp;<input type="text" style="width:79%;display:inline" name="telefono" value="<%=ViewData["QuieroTelefono"]%>"/>
                    </div></label>
                    <label class="short" style="vertical-align:top">Horario de Contacto:<input type="text"  name="horario" value="<%=ViewData["QuieroHorario"]%>"/></label>
                    <fieldset id="fields">
                        ...
                        <label class="obligatorio">Colonia:<input type="text" name="colonia" value="<%=ViewData["QuieroColonia"]%>"/></label>
                        <label class="obligatorio short">C&oacute;digo Postal:<input type="text" name="cpostal" value="<%=ViewData["QuieroCP"]%>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/></label>
                    ...
                    <%=ViewData["Paquete"]%> 
                        <p>He leído y estoy de acuerdo con el <a href="/aviso-de-privacidad" target="_blank">aviso de privacidad</a></p>
