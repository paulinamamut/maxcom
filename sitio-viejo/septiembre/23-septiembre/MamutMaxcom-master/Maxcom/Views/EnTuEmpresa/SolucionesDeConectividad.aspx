...
<head>
<meta charset="UTF-8">
<title>Maxcom | Soluciones de Conectividad</title>
...
<meta property="og:url" content="http://www.maxcom.com/en-tu-empresa/soluciones-de-conectividad" /> 
...
<!-- ********************* Empieza Lightbox ********************* -->
    <div id="lightbox">
		<div class="transparencia lightbox-panel">
    ...
    <div id="wrapper">
            ...
            <nav role="navigation" id="main_nav">
                <ul id="nav">
                    ...
                    <li><a href="/en-tu-empresa/" class="current">maxcom for Business</a>
                        <ul id="submenu">
                            <li><span class="current">Hug Connectivity</span></li>
        ...
        <!--[if lt IE 9]><div class="section conectividad"><![endif]--><!--[if gte IE 9]><!--><section class="conectividad"><!--<![endif]-->
        <div class="pad">
            <h1 class="icon business foryou">Hug Connectivity</h1>
            <p>Los Servicios de Conectividad ofrecen la tecnolog&iacute;a m&aacute;s avanzada para conexiones de voz, datos e Internet que permiten a las empresas conformar redes privadas para la comunicaci&oacute;n de datos entre sus oficinas y sistemas, ofrecen acceso dedicado a Internet de alta velocidad y conexi&oacute;n telef&oacute;nica local, nacional, internacional y m&oacute;vil.</p>
            <p>Son ideales para cualquier empresa que desea tener la m&aacute;s alta disponibilidad de acceso a las redes de voz e internet para as&iacute; compartir aplicaciones con clientes, proveedores y empleados, adem&aacute;s estas soluciones est&aacute;n dise&ntilde;adas para empresas que requieren disminuir los costos operativos y de inversi&oacute;n en administraci&oacute;n de tecnolog&iacute;as de conmutaci&oacute;n de voz y datos ya que tambi&eacute;n contamos con soluciones de equipamiento administrado.</p>
        </div>
        <!--[if gte IE 9]><!--></section><!--<![endif]--><!--[if lt IE 9]></div><![endif]-->
        
<!-- **************************************************************************************************************************************** -->
        
        <!--[if lt IE 9]><div class="section dark last"><![endif]--><!--[if gte IE 9]><!--><section class="dark last"><!--<![endif]-->
        <div class="pad">
            <div class="half">
            <img alt="Empresas peque&ntilde;as" src="/img/contenido/hug-conectivity.jpg" class="imagen-half">
            <a href="http://www.youtube.com/embed/VUOsPFi021I" class="btn-sombra show">Ver Video</a>
            </div>
            <div class="box half-cont conectividad">
                    <h5>Beneficios</h5>
                    <ul>
                        <li>Reducci&oacute;n de costos de telecomunicaciones</li>
                        <li>Conexi&oacute;n a la red de datos con alta disponibilidad y confiabilidad</li>
                        <li>Un solo punto de contacto para toda su infraestructura</li>
                        <li>Atenci&oacute;n personalizada altamente capacitada para resolver sus necesidades</li>
                        <li>Entrega de servicios con diversas tecnolog&iacute;as que se adaptan a las necesidades del cliente</li>
                        <li>Alta disponibilidad de servicios</li>
                        <li>Red de datos de alta velocidad</li>
                    </ul>
                </div>
            </div>
        <!--[if gte IE 9]><!--></section><!--<![endif]--><!--[if lt IE 9]></div><![endif]-->
