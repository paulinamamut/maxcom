...
<meta property="og:url" content="http://www.maxcom.com/atencion-a-clientes/envianos-un-mensaje/" /> 
...
<body id="inner">
    ...
    <div id="wrapper">
        <!--[if lt IE 9]><div id="header"><![endif]--><!--[if gte IE 9]><!--><header><!--<![endif]-->
            ...
            <ul id="nav">
                    ...
                    <li><a href="/atencion-a-clientes/" class="current">Atenci&oacute;n a clientes</a>
                        <ul id="submenu">
                            <li><span class="current">Env&iacute;anos un mensaje</span></li>
        ...
        <div class="pad">
            ...
            <p>En maxcom te ofrecemos un servicio de preferencia, si tienes dudas o cualquier inquietud puedes contactarnos utilizando el siguiente formato. Si a&uacute;n no eres cliente y quieres mayor informaci&oacute;n sobre cobertura en tu zona <a href="/localizador/">haz clic aqu&iacute;</a>. Uno de nuestros ejecutivos se pondr&aacute; en contacto contigo para responderte a la brevedad.</p>
                <div class="half ext">
                    <a href="/atencion-a-clientes/envianos-un-mensaje/quiero-ser-cliente" class="product half clientes">
                        <h3>Quiero ser cliente maxcom</h3>
                        <p>Descubre por qu&eacute; maxcom es para ti.</p>
                        <strong class="cta">Enviar mensaje</strong>
                    </a><!--
                    --><a href="/atencion-a-clientes/envianos-un-mensaje/ya-soy-cliente" class="product half clientes">
                        <h3>Ya soy cliente maxcom</h3>
