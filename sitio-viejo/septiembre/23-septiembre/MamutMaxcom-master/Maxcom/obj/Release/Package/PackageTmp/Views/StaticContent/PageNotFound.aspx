    ...
    <div id="wrapper" class="tc">
        ...
        <!--[if lt IE 9]><div class="section"><![endif]--><!--[if gte IE 9]><!--><section><!--<![endif]-->
            <div class="pad">
                ...
                <h2>Parece que la p&aacute;gina que est&aacute;s buscando no existe</h2>
                <p>La direcci&oacute;n a la que trataste de entrar no existe, puede ser que sea una liga vieja o que la direcci&oacute;n est&eacute; mal escrita. Prueba lo siguiente:</p>
                <ul>
                    <li>Verifica que la direcci&oacute;n est&eacute; escrita correctamente.</li>
                    <li>Consulta nuestro <a href="/sitemap/">mapa de sitio</a>.</li>
