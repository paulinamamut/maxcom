...
<body id="inner">
    ...
    <div id="wrapper" class="tc">
        ...
        <div class="pad">
            ...
            <div class="half">
                <ul class="half">
                    <li><a href="/en-tu-hogar/"><em>max</em>Conexión</a>
                        <ul>
                            <li><a href="/en-tu-hogar/max-conexion/"><em>max</em>Conexión</a></li>
                            <li><a href="/en-tu-hogar/max-conexion/"><em>max</em>Diversión</a></li>
                            <li><a href="/en-tu-hogar/max-conexion/"><em>max</em>Móvil</a></li>
                            <li><a href="/en-tu-hogar/max-conexion/">Arma tu Paquete</a></li>
                        </ul>
                    </li>
                </ul><!--
                --><ul class="half">
            ...
            --><div class="half">
                <ul class="half">
                    <li><a href="/atencion-a-clientes/">Atención a clientes</a>
                        <ul>
                            <li><a href="/atencion-a-clientes/envianos-un-mensaje/">Envíanos un mensaje</a>
                                <ul>
                                    <li><a href="/atencion-a-clientes/envianos-un-mensaje/quiero-ser-cliente/">Quiero ser cliente</a></li>
                                    <li><a href="/atencion-a-clientes/envianos-un-mensaje/ya-cliente/">Ya soy cliente</a></li>
                                </ul>
                            </li>
