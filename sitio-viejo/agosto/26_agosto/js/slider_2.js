var slider, body, tray, slides, controles, main, main_nav, header, mn_height, bbefore;
$(function(){
	slider = $('#slider');
    if(slider.length > 0){
        var tiempo = 8;
    ...
    if(typeof(slider.swipe) == "function"){
        slider.swipe({
            swipeLeft:function(){slide('next')},
            swipeRight:function(){slide('prev')}
        });
    }
