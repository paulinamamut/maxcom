...
<meta property="og:url" content="http://www.maxcom.com/acceso-clientes/" /> 
...
<body id="inner">
    ...
    <div id="wrapper" class="tc">
        <!--[if lt IE 9]><div id="header"><![endif]--><!--[if gte IE 9]><!--><header><!--<![endif]-->
            ...
            <a id="clientes" href="/acceso-clientes/">&iquest;Ya eres cliente&#63; <span>Accede aquí</span></a>
        ...
        <div class="pad">
            <h1 class="icon acceso">Acceso a Clientes</h1>
            <p>Te damos acceso a las herramientas para que le saques el mayor provecho a tus servicios.</p>
            <div class="half">
                    <a href="http://mail.maxcom.net.mx/" class="product half clientes">
                        <h3>Consulta tu Mail</h3>
                        <p>Accede a tus cuentas de correo maxcom.</p>
                        <strong class="cta">Accede aqu&iacute;</strong>
                    </a><!--
                    --><a href="http://audioconferencia.maxcom.com/" class="product half clientes">
                        <h3>Accede a Audio Conferencia</h3>
                        <p>Una forma p&aacute;ctica de mantenerte conectado.</p>
                        <strong class="cta">Accede aqu&iacute;</strong>
                    </a>
            </div><!-- 
            --><div class="half">
                    <a href="https://webhosting02.maxcom.net.mx/FacturaWeb/" class="product half clientes">
                        <h3>Detalle de llamadas<br/><span class="clientes_comerciales">Sólo clientes comerciales</span></h3>
                        <p>Consulta el detalle de tus llamadas.</p>
                        <strong class="cta">Accede aqu&iacute;</strong>
                    </a><!--
                    --><a href="/acceso-clientes/mi-cuenta/" class="product half clientes">
                        <h3>Mi cuenta maxcom</h3>
